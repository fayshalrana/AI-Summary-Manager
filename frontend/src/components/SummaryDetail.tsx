  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        <div className="flex justify-between items-center p-6 border-b">
          ...
          <button
            onClick={onClose}
            className="text-white hover:text-red-700 border-transparent bg-purple-50 hover:!bg-red-200 px-3 py-1 focus:outline-none transition-colors transition-transform duration-300 ease-in-out !border-2 hover:!border-red-800 !py-[10px] !px-[8px]"
          >
