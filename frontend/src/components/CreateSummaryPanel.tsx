              ...
              >
                <div className="flex flex-col items-center space-y-3">
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                    isDragOver ? 'bg-green-100' : 'bg-purple-100'
                  }`}>
                    <svg className={`w-6 h-6 ${isDragOver ? 'text-green-600' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-100 p-4 rounded-lg max-h-40 overflow-y-auto custom-scrollbar">
