  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-blue-600">
                Your current balance: <strong>{user?.credits || 0} credits</strong>
              </p>
            </div>
            {user && user.credits < 1 && (
        ...
        <button
          type="submit"
          disabled={loading || (user?.credits || 0) < 1 || (inputMethod === 'text' && !formData.text.trim()) || (inputMethod === 'file' && !selectedFile)}
